package com.bobo.iamhere.utils;
...
public class PermissionUtils {
    ...
    //Permessi necessari per le operazioni di localizzazione
     ...
     * STORAGE
     */
    public static boolean checkSelfPermission_LOCATION(Activity activity)
    {
