    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(OggettiActivity.this);
        ...
        ArrayList<StanzaDao> elencoStanze = DatabaseManager.getAllStanze(MainActivity.database);

        //Inizializzo la ListView
        listaOggettiView = findViewById(R.id.listaOggettiView);
        elencoOggetti = DatabaseManager.getAllOggetti(MainActivity.database, false);
