...
public class OggettiScadenzaActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_oggetti_scadenza);
        ...
        actionBar.setSubtitle(getResources().getString(R.string.title_activity_oggetti_scadenza));
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(OggettiScadenzaActivity.this);
        ...
        elencoOggetti = DatabaseManager.getAllOggetti(MainActivity.database, true);
    ...
    public void aggiornaLista(ArrayList<OggettoDao> elencoNew, boolean aggiornaDaDB)
    {
        ...
        ((OggettoAdapter) valori).setEvidenziaDataScadenza(true);
    ...
    private void search(String searchText)
    {
        ...
        for (OggettoDao dao: elencoOggetti) {
            if(dao.searchItem(searchText, true))
