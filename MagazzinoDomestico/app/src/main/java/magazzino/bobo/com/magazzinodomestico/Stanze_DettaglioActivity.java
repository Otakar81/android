...
public class Stanze_DettaglioActivity extends AppCompatActivity
    ...
    long ID_STANZA_SELEZIONATA;
    String NOME_STANZA_SELEZIONATA;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stanze__dettaglio);
        ...
        listaView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(tipoElementiDaMostrare == LocationDao.MOBILE) //Entro nel dettaglio del mobile
                {
        ...
        listaView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                if(tipoElementiDaMostrare == LocationDao.MOBILE) //Apro il dialog di modifica del mobile
                {
                    MobileDao dao = (MobileDao) parent.getItemAtPosition(position); //elencoMobili.get(position);

                    AlertDialog.Builder builder = new AlertDialog.Builder(Stanze_DettaglioActivity.this);
                    MobileDialog dialog = MobileDialog.newInstance(builder, true, location); //TODO -> Supporto per location
                    dialog.show(getSupportFragmentManager(),"mobile_dialog");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.stanze__dettaglio, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_mostra_mobili) {
            ...
            if(tipoElementiDaMostrare != LocationDao.MOBILE) //Faccio qualcosa solo se non sto già mostrando i mobili
            {
                ...
                //Popolo la lista
                aggiornaListaMobili(elencoMobili, false);
            }

            return true;

        } else if (id == R.id.action_mostra_contenitori) {
     ...
     * @param aggiornaDaDB
     */
    public void aggiornaListaMobili(ArrayList<MobileDao> elencoNew, boolean aggiornaDaDB)
    {
        //La variabile globale deve essere aggiornata, ma solo se sto aggiornando la lista dopo una modifica su DB
        if(aggiornaDaDB)
        {
    ...
    {
        //SEffettuo una ricerca sulla lista che sto mostrando attualmente
        if (tipoElementiDaMostrare == LocationDao.MOBILE) {
            ...
            aggiornaListaMobili(elencoRistretto, false);

        } else if (tipoElementiDaMostrare == LocationDao.CONTENITORE) { //Sto mostrando i contenitori
    ...
    private void cambiaTitolo()
    {
        ...
        if (tipoElementiDaMostrare == LocationDao.MOBILE) {
            ...
            colorDark = R.color.colorMobiliDark;
            color = R.color.colorMobili;
