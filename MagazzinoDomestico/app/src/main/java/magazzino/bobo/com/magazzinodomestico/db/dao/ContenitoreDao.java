...
public class ContenitoreDao {
    ...
    public ContenitoreDao(long id, String nome, String immagine, long id_categoria, long id_stanza, long id_mobile) {
        this.id = id;
        this.nome = nome;
    ...
    public ContenitoreDao(long id, String nome, long id_categoria, long id_stanza, long id_mobile) {
        this.id = id;
        this.nome = nome;
        this.id_categoria = id_categoria;
        this.id_stanza = id_stanza;
    ...
    public ContenitoreDao(long id, String nome, long id_stanza, long id_mobile) {
        this.id = id;
        this.nome = nome;
        this.id_stanza = id_stanza;
        this.id_mobile = id_mobile;
